...
// --- HARDENED FIRESTORE ERROR HANDLING INTERFACE ---
...
/**
 * Catches Firebase Firestore security/permission failures and structured-logs them
 * as standard JSON for platform diagnostics.
 */
